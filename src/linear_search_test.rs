...
mod linear_search_test {
    ...
    fn linear_search_array() {
        ...
        assert_eq!(crate::linear_search::linear_search(&arr, 1336), true);
        assert_eq!(crate::linear_search::linear_search(&arr, 69420), true);
        assert_eq!(crate::linear_search::linear_search(&arr, 69421), true);
        assert_eq!(crate::linear_search::linear_search(&arr, 1), true);
        assert_eq!(crate::linear_search::linear_search(&arr, 0), true);
    }
}
